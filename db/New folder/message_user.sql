...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2022 at 01:28 PM
...
ALTER TABLE `message_user`
  ...
  ADD KEY `message_user_issue_id_foreign` (`issue_id`),
...
--
ALTER TABLE `message_user`
  ADD CONSTRAINT `message_user_issue_id_foreign` FOREIGN KEY (`issue_id`) REFERENCES `issues` (`id`) ON DELETE CASCADE,
