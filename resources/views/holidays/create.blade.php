  ...
  <div class="content rempm">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-12">
          <form method="post" action="{{ route('holiday.store') }}" autocomplete="off" class="form-horizontal frm-prevent-multiple-submit">
            @csrf
            @method('post')
            <div class="card mb-8">
              <div class="card-header card-header-rose card-neda">
                <div class="card-body">
                  <div class="row">
                    ...
                    <h4 class="card-titleX">{{ __('Add Holiday') }}</h4>
                  </div>
                </div>
              </div>
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('date') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('date') ? ' is-invalid' : '' }}" name="date" id="input-date" type="date" value="{{ old('date') }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-7 checkbox-radios mt-16" style="margin-top: 15px;">
                    <div class="form-check form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="repeat" value="1" @if(old('repeat') == 1) checked @endif>Yes
                        <span class="circle">
                    ...
                    <div class="form-check form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="repeat" value="0" @if(old('repeat', 0) == 0) checked @endif>No
                        <span class="circle">
                          <span class="check"></span>
                        </span>
                      </label>
