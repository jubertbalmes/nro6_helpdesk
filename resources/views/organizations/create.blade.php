...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('organization.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">{{ __('Add Organization') }}</h4>
              </div>
              <div class="card-body ">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('org_code') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('org_code') ? ' is-invalid' : '' }}" name="org_code" id="input-org_code" type="text"  value="{{ old('org_code') }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('short_name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('short_name') ? ' is-invalid' : '' }}" name="short_name" id="input-short_name" type="text"  value="{{ old('short_name') }}" required="true" aria-required="true"/>
