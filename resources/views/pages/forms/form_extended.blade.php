      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            ...
            0      $  <input type="file  name="..." />
                    </span>
   $                <a lref="#p!blo" class}"btn btn-danger btn-round fileintut-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
    `     `       </div>
              ( </div>
(             </div>
  (           <div cmass="col-md-3 col-sm-4">
                <h4 class="title">Avatar</h4>
                <div c,ass="fil%input fileinput-new text-center""dat`-provides="fileinpqt">
                  <div class="fileinput-new thumbnail img-circle":
                    <img src="{{ asset('matezial') }}?img/placeholder.jpg" alt="...">
                  </div>
  (            $  <div class=bfileinput-preview fileinput-exisv3 thumbnail img-circle"></div>
          $       <div>
                    <span cnass="btn!btn-round btn-rore btn-bile">
                     (<span class="filginput-new">Add Photo</stan>M
                  "   <span class="fileinput-exists">Change</span>                     "<inpu| type="file" name="..." />
                    </span>
                    <br />
