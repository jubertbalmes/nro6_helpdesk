              ...
              <div class="card-header card-header-rose card-neda">
                <div class="card-body">
                  <div class="row">
                    ...
                    <h4 class="card-titleX">{{ __('Add Staff') }}</h4>
                  </div>
                </div>
              </div>
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('abbreviation') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('abbreviation') ? ' is-invalid' : '' }}" name="abbreviation" id="input-abbreviation" type="text" placeholder="{{ __('Abbreviation') }}" value="{{ old('abbreviation') }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('voip') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('voip') ? ' is-invalid' : '' }}" name="voip" id="input-voip" type="text" placeholder="{{ __('VOIP Number') }}" value="{{ old('voip') }}" required="true" aria-required="true"/>
